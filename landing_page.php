...
<head>
    ...
    <title>EDUIAIO - Formación Digital para Mayores</title>
...
<body>
    ...
    <header id="landing-header"
        class="py-3 px-10 flex items-center fixed top-0 w-full justify-between z-40 text-white transition-colors duration-300">
        <div class="flex flex-grow basis-0">
            <a href="./" class="text-current font-bold text-xl tracking-tighter">EDUIAIO</a>
        </div>
    ...
    <main class="snap-y snap-mandatory relative w-full h-screen overflow-y-auto overflow-x-hidden scroll-smooth">
        ...
        <section class="landing-section bg-black h-screen w-screen text-center overflow-hidden relative snap-center"
            data-header-color="white" id="inicio">
            <div class="z-30 relative h-full flex flex-col">
                <header>
                    <h2 class="text-white pt-40 text-[40px] font-medium">Tecnología sin edad</h2>
                    <p class="text-white text-sm">Descubre el mundo digital a tu ritmo</p>
                </header>
                <footer class="flex flex-col flex-grow justify-end pb-20">
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a class="bg-white/5 backdrop-blur-sm border-[3px] border-white text-sm rounded font-medium text-white px-12 py-2 inline-block hover:bg-white hover:text-black transition-colors"
                            href="registro.php">
                            Comenzar Ahora
                        </a>
                        <a class="bg-white text-sm rounded font-medium text-black px-12 py-2 transition-colors hover:bg-gray-200 inline-flex justify-center items-center"
                            href="#iniciacion">
                            Saber más
                        </a>
                    </div>
            ...
            <div class="absolute top-0 bottom-0 h-full w-full z-10">
                <video class="object-center object-cover h-full w-full" autoplay muted loop
                    src="recursos/imagenes/hero.webm"></video>
            </div>
        </section>

        <!-- Section 1: Iniciación -->
        <section class="landing-section bg-zinc-900 h-screen w-screen text-center overflow-hidden relative snap-center"
            data-header-color="white" id="iniciacion">
            <div class="z-30 relative h-full flex flex-col">
                <header>
                    <h2 class="text-white pt-40 text-[40px] font-medium">Iniciación Digital</h2>
                    <p class="text-white text-sm underline">Pierde el miedo al ordenador</p>
                </header>
                <footer class="flex flex-col flex-grow justify-end pb-20">
                    <div class="flex gap-x-6 justify-center">
                        <a class="bg-zinc-800 text-sm rounded font-medium text-white px-12 py-2 inline-block transition-colors hover:bg-zinc-700"
                            href="ver_cursos.php">Ver Cursos</a>
                    </div>
                </footer>
            </div>
            <div class="absolute top-0 bottom-0 h-full w-full z-10">
                <img src="recursos/imagenes/iniciacion.jpg" alt="Iniciación"
                    class="h-full w-full object-cover object-center" />
            </div>
        </section>

        <!-- Section 2: Comunicación -->
        <section class="landing-section bg-zinc-900 h-screen w-screen text-center overflow-hidden relative snap-center"
            data-header-color="black" id="comunicacion">
            <div class="z-30 relative h-full flex flex-col">
                <header>
                    <h2 class="text-black pt-40 text-[40px] font-medium">Comunicación y Redes</h2>
                    <p class="text-black text-sm underline">Conecta con tus seres queridos</p>
                </header>
                <footer class="flex flex-col flex-grow justify-end pb-20">
                    <div class="flex gap-x-6 justify-center">
                        <a class="bg-gray-800 text-sm rounded font-medium text-white px-12 py-2 inline-block hover:bg-gray-700 transition-colors"
                            href="descubrir.php">Descubrir</a>
                    </div>
                </footer>
            </div>
            <div class="absolute top-0 bottom-0 h-full w-full z-10">
                <img src="recursos/imagenes/comunicacion.jpg" alt="Comunicación"
                    class="h-full w-full object-cover object-center" />
            </div>
        </section>
        ...
        <!-- Section 3: Trámites -->
        <section class="landing-section bg-zinc-900 h-screen w-screen text-center overflow-hidden relative snap-center"
            data-header-color="black" id="tramites">
            <div class="z-30 relative h-full flex flex-col">
                <header>
                    <h2 class="text-black pt-40 text-[40px] font-medium">Trámites Online</h2>
                    <p class="text-black text-sm underline">Banca, Salud y Administración</p>
                </header>
                <footer class="flex flex-col flex-grow justify-end pb-20">
                    <div class="flex gap-x-6 justify-center">
                        <a class="bg-white text-sm rounded font-medium text-black px-12 py-2 inline-block transition-colors hover:bg-gray-200 border border-gray-300 shadow-sm"
                            href="aprender_mas.php">Aprender Más</a>
                    </div>
                </footer>
            </div>
            <div class="absolute top-0 bottom-0 h-full w-full z-10">
                <img src="recursos/imagenes/tramites.jpg" alt="Trámites"
                    class="h-full w-full object-cover object-center" />
            </div>
        </section>
        ...
        <!-- Section 4: Ocio -->
        <section class="landing-section bg-zinc-900 h-screen w-screen text-center overflow-hidden relative snap-center"
            data-header-color="white" id="ocio">
            <div class="z-30 relative h-full flex flex-col">
                <header>
                    <h2 class="text-white pt-40 text-[40px] font-medium">Ocio y Bienestar</h2>
                    <p class="text-white text-sm underline">Disfruta de tu tiempo libre</p>
                </header>
                <footer class="flex flex-col flex-grow justify-end pb-20">
                    <div class="flex gap-x-6 justify-center">
                        <a class="bg-white/10 backdrop-blur-md border border-white/50 text-sm rounded font-medium text-white px-12 py-2 inline-block hover:bg-white/20 transition-colors"
                            href="ocio.php">Descubrir Ocio</a>
                    </div>
                </footer>
            </div>
            <div class="absolute top-0 bottom-0 h-full w-full z-10">
                <img src="recursos/imagenes/senior-friends-having-party-night.jpg" alt="Ocio"
                    class="h-full w-full object-cover object-center" />
            </div>
        </section>
    ...
    <!-- Dock Menu -->
    <div
        class="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 xl:hidden flex justify-around gap-4 items-center px-4 py-1 bg-black rounded-[15px] ring-1 ring-white">
        <div
    ...
    <script>
        // --- Header Color Change Logic (Intersection Observer) ---
        const header = document.querySelector('#landing-header');
        const observerOptions = {
            root: null,
            rootMargin: '0px',
            threshold: 0.90 // Change when section is 90% visible
        };
